...
class Pokemon:
    ...
    def __init__(self, pokemon_trainer):
        ...
        self.power=random.randint(15,50)
        self.image_url = None
    ...
    async def info(self):
        ...
        return f"Pokémonunuzun ismi: {self.name}, Pokemonun sağlığı: {self.hp}, Pokemonun gücü: {self.power}"  # Pokémon'un adını içeren dizeyi döndürür
